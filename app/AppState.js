...
class AppState extends EventEmitter {
  ...
  house = [
    new House({year: 2001, price: 400000, bed: 4, bath:3, img:"https://thiscatdoesnotexist.com/", description: "It's a house"}),
    new House({year: 1992, price: 325000, bed: 3, bath: 2, img:"https://thiscatdoesnotexist.com", description: "It's another house"})
  ]
